...
vec2 tx = vec2(uTime * 0.0015 + uNoiseId, transformed.x * 5.0  + transformed.y * 6.3);
vec2 ty = vec2(uTime * 0.0010 + uNoiseId, transformed.y * 1.0  + transformed.z * 5.0);
vec2 tz = vec2(uTime * 0.0020 + uNoiseId, transformed.z * -2.3 + transformed.x * 4.5);

transformed.x += noise(tx) * 0.5 - 0.25;
transformed.y += noise(ty) * 0.5 - 0.25;
transformed.z += noise(tz) * 0.5 - 0.25;
`
