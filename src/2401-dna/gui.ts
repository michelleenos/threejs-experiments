...
const getThreeJsCodeForItem = (
    item: THREE.Vector3 | THREE.Euler,
    name: string,
) => {
...
export const buildGui = (
    ...
    fShader
        .add(particles.material.uniforms.uScaleMain, 'value', 0, 10, 0.1)
        .name('scale main')
    fShader
        .add(particles.material.uniforms.uScaleMiddle, 'value', 0, 10, 0.1)
        .name('scale middle')
    fShader
        .add(particles.material.uniforms.uNoiseResolution, 'value', 0, 10, 0.1)
        .name('noise resolution')
    fShader
        .add(particles.material.uniforms.uNoiseRadius, 'value', 0, 1, 0.01)
        .name('noise radius')
    fShader
        .add(particles.material.uniforms.uSpeed, 'value', 0, 1, 0.01)
        .name('speed')
    fShader
        .add(particles.material.uniforms.uSquishMain, 'value', 0, 1, 0.001)
        .name('squish main')
    fShader
    ...
    let controlsBtn = gui.add(obj, 'switchToFlyControls')
}
...
const switchToControls = (
    ...
    let manualControlsBtn = gui.controllers.find(
        (c) => c._name === 'switchToManualControls',
    )
